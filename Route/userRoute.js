...
import { signUpValidator,signInValidator,resetPasswordValidation,forgotpasswordValidation, validateUpdate} from '../Utils/validation.js';
...
route.patch('/updateUserProfile/:id',authenticateToken,validateUpdate,updateUserProfile)
